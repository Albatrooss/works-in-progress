    ...
    <div className="classes-container">
      <div className="row">
        <div className="my-outline-class col s12 l8 offset-l2">
          ...
          <h6>These online dance and Pilates classes are posted weekly on Sunday evening! Remember that it is <span>not about perfection</span>, it is about communicating emotions through <span>authentic movement</span>. Let joy be your guide as you enjoy the process and let go of outcomes.</h6>
        </div>
